...
public class ListSpeciesService {
    
    private static final Logger LOGGER = Logger.getLogger(ListSpeciesService.class.getName());
    private final TreeSpeciesDAO treeSpeciesDAO;
      public ListSpeciesService() {
    ...
    public ListSpeciesService(TreeSpeciesDAO treeSpeciesDAO) {
