    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarMain">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link <%= path.equals("/actividades") ? "active" : "" %>" href="${pageContext.request.contextPath}/actividades"><i class="fas fa-leaf"></i> Actividades</a></li>
